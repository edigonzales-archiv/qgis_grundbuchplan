...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="6000" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="&quot;art&quot;  IN ('Bruecke_Passarelle', 'Brunnen', 'massiver_Sockel', 'Mast_Antenne', 'Mauer', 'Pfeiler', 'Rinnsal', 'Ruine_archaeologisches_Objekt', 'Schwelle', 'Uferverbauung', 'wichtige_Treppe')" label="ausgezogen">
        ...
        <rule scalemaxdenom="6000" filter="&quot;art&quot;  &lt;> 'wichtige_Treppe'" symbol="4" scalemindenom="3000" label="1:5000"/>
      </rule>
      <rule filter="&quot;art&quot; IN ('Druckleitung', 'Hochspannungsfreileitung')" label="strichpunktiert1">
      ...
      <rule filter="&quot;art&quot; IN ('Achse', 'Bahngeleise', 'Faehre', 'Gondelbahn_Sesselbahn', 'Luftseilbahn', 'Materialseilbahn', 'Skilift')" label="strichpunktiert2">
      ...
      <rule filter="&quot;art&quot; IN ('eingedoltes_oeffentliches_Gewaesser', 'unterirdisches_Gebaeude')" label="punktiert">
