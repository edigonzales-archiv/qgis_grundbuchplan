    ...
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="customdash" v="4.9;1.4;1.4;1.4;1.4;1.4"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
          <prop k="penstyle" v="solid"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="line" name="2">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="0,0,0,255"/>
          <prop k="customdash" v="3.5;1;1;1;1;1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
          <prop k="penstyle" v="solid"/>
          <prop k="use_custom_dash" v="1"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="line" name="3">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="0,0,0,255"/>
          <prop k="customdash" v="2.45;0.7;0.7;0.7;0.7;0.7"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
          <prop k="penstyle" v="solid"/>
          <prop k="use_custom_dash" v="1"/>
      ...
      <symbol outputUnit="MM" alpha="1" type="line" name="4">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="0,0,0,255"/>
          <prop k="customdash" v="1.715;0.49;0.49;0.49;0.49;0.49"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
          <prop k="penstyle" v="solid"/>
          <prop k="use_custom_dash" v="1"/>
