...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="300" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="befestigt.uebrige_befestigte.uebrige_befestigte" label="befestigt.uebrige_befestigte.uebrige_befestigte"/>
      <category symbol="1" value="befestigt.Wasserbecken" label="befestigt.Wasserbecken"/>
      <category symbol="2" value="bestockt.uebrige_bestockte.Hecke" label="bestockt.uebrige_bestockte.Hecke"/>
      <category symbol="3" value="Gebaeude" label="Gebaeude"/>
      <category symbol="4" value="Gewaesser.fliessendes" label="Gewaesser.fliessendes"/>
      <category symbol="5" value="Gewaesser.stehendes" label="Gewaesser.stehendes"/>
      <category symbol="6" value="humusiert.Acker_Wiese_Weide.Acker_Wiese" label="humusiert.Acker_Wiese_Weide.Acker_Wiese"/>
    </categories>
    <symbols>
