...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="6000" hasScaleBasedVisibilityFlag="1">
  <transparencyLevelInt>255</transparencyLevelInt>
  <renderer-v2 attr="art_txt" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Baulinie" label="Baulinie"/>
      <category symbol="1" value="Gestaltungsbaulinie" label="Gestaltungsbaulinie"/>
      <category symbol="2" value="Strasse" label="Strasse"/>
      <category symbol="3" value="Waldabstandslinie" label="Waldabstandslinie"/>
      <category symbol="4" value="weitere.Vorbaulinie" label="Vorbaulinie"/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype type="0" name="datenverwaltungsstelle"/>
    <edittype type="0" name="datenverwaltungsstelle_txt"/>
    <edittype type="0" name="datum_genehmigung"/>
    <edittype type="0" name="gem_bfs"/>
    <edittype type="0" name="lieferdatum"/>
    <edittype type="0" name="los"/>
    <edittype type="0" name="objekt"/>
    <edittype type="0" name="ogc_fid"/>
    <edittype type="0" name="planbeschriftung"/>
